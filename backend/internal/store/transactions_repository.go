...
func (r *pgTransactionsRepository) ListTransactions(ctx context.Context, f ListFilter) ([]Transaction, TransactionListResult, error) {
	...
	err := r.metrics.Observe(ctx, "transactions.list", func(ctx context.Context) error {
		var err error
		txns, result, err = r.listTransactionsQuery(ctx, f)
		return err
	})
...
func (r *pgTransactionsRepository) GetTransaction(ctx context.Context, id string) (*Transaction, error) {
	var txn *Transaction
	err := r.metrics.Observe(ctx, "transactions.get", func(ctx context.Context) error {
		var err error
		txn, err = r.getTransactionQuery(ctx, id)
		return err
	})
	return txn, err
}
...
func (r *pgTransactionsRepository) UpdateDescription(ctx context.Context, id, description string) error {
	return r.metrics.Observe(ctx, "transactions.update_description", func(ctx context.Context) error {
...
func (r *pgTransactionsRepository) AddLabel(ctx context.Context, transactionID, label string) error {
	return r.metrics.Observe(ctx, "transactions.add_label", func(ctx context.Context) error {
...
func (r *pgTransactionsRepository) AddLabels(ctx context.Context, transactionID string, labels []string) error {
	return r.metrics.Observe(ctx, "transactions.add_labels", func(ctx context.Context) error {
		if len(labels) == 0 {
			return nil
		}
...
func (r *pgTransactionsRepository) RemoveLabel(ctx context.Context, transactionID, label string) error {
	return r.metrics.Observe(ctx, "transactions.remove_label", func(ctx context.Context) error {
		tx, err := r.pool.Begin(ctx)
		if err != nil {
...
func (r *pgTransactionsRepository) SearchTransactions(
	...
	var txns []Transaction
	var result TransactionListResult
	err := r.metrics.Observe(ctx, "transactions.search", func(ctx context.Context) error {
		var err error
		txns, result, err = r.searchTransactionsQuery(ctx, query, f)
		return err
	})
	return txns, result, err
}
...
func (r *pgTransactionsRepository) GetFacets(ctx context.Context) (*Facets, error) {
	var facets *Facets
	err := r.metrics.Observe(ctx, "transactions.get_facets", func(ctx context.Context) error {
		var err error
		facets, err = r.getFacetsQuery(ctx)
		return err
	})
	return facets, err
}
...
func (r *pgTransactionsRepository) UpdateTransaction(ctx context.Context, id string, u TransactionUpdate) error {
	return r.metrics.Observe(ctx, "transactions.update", func(ctx context.Context) error {
...
func (r *pgTransactionsRepository) MuteTransaction(ctx context.Context, id string, muted bool, reason string) error {
	return r.metrics.Observe(ctx, "transactions.mute", func(ctx context.Context) error {
...
func (r *pgTransactionsRepository) UpdateMuteReason(ctx context.Context, id, reason string) error {
	return r.metrics.Observe(ctx, "transactions.update_mute_reason", func(ctx context.Context) error {
		tag, err := r.pool.Exec(ctx,
...
func (r *pgTransactionsRepository) UpdateMerchantReason(ctx context.Context, id, reason string) error {
	return r.metrics.Observe(ctx, "transactions.update_merchant_reason", func(ctx context.Context) error {
		tag, err := r.pool.Exec(ctx,
...
func (r *pgTransactionsRepository) MuteByMerchant(ctx context.Context, pattern, reason string) error {
	return r.metrics.Observe(ctx, "transactions.mute_by_merchant", func(ctx context.Context) error {
		tx, err := r.pool.Begin(ctx)
		if err != nil {
...
func (r *pgTransactionsRepository) ListMutedMerchants(ctx context.Context) ([]MutedMerchant, error) {
	...
	err := r.metrics.Observe(ctx, "transactions.list_muted_merchants", func(ctx context.Context) error {
		var err error
		result, err = r.listMutedMerchantsQuery(ctx)
		return err
	})
	return result, err
}
...
func (r *pgTransactionsRepository) GetMutedMerchantsWithCount(ctx context.Context) ([]MutedMerchantWithCount, error) {
	...
	err := r.metrics.Observe(ctx, "transactions.get_muted_merchants_with_count", func(ctx context.Context) error {
		var err error
		result, err = r.getMutedMerchantsWithCountQuery(ctx)
		return err
	})
	return result, err
}
...
func (r *pgTransactionsRepository) DeleteMutedMerchant(ctx context.Context, id string) error {
	return r.metrics.Observe(ctx, "transactions.delete_muted_merchant", func(ctx context.Context) error {
...
func (r *pgTransactionsRepository) UnmuteByPattern(ctx context.Context, pattern string) error {
	return r.metrics.Observe(ctx, "transactions.unmute_by_pattern", func(ctx context.Context) error {
...
func (r *pgTransactionsRepository) DeleteMutedMerchantAndUnmute(ctx context.Context, id string) error {
	return r.metrics.Observe(ctx, "transactions.delete_muted_merchant_and_unmute", func(ctx context.Context) error {
		tx, err := r.pool.Begin(ctx)
		if err != nil {
...
func (r *pgTransactionsRepository) GetMutedMerchantPatterns(ctx context.Context) ([]string, error) {
	var patterns []string
	err := r.metrics.Observe(ctx, "transactions.get_muted_merchant_patterns", func(ctx context.Context) error {
		rows, err := r.pool.Query(ctx, `SELECT pattern FROM muted_merchants`)
		if err != nil {
			return fmt.Errorf("fetching muted merchant patterns: %w", err)
		}
		defer rows.Close()
		for rows.Next() {
			var p string
			if err := rows.Scan(&p); err != nil {
				return fmt.Errorf("scanning pattern: %w", err)
			}
