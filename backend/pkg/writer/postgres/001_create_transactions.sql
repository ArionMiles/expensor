...
-- Mute columns (idempotent for upgrades).
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS muted BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS muted_by_merchant BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS mute_reason TEXT;
...
-- Muted merchant patterns: auto-mute future transactions at write time.
...
ALTER TABLE muted_merchants ADD COLUMN IF NOT EXISTS reason TEXT;
